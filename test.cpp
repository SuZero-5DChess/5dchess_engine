...
int main()
{
    auto m = temp_move("(-3T2)Qa2c5");
    actions a = actions::branch(temp_move::submit(), {
            actions::leaf(temp_move("(0T1)Ra1b1")),
            actions::branch(temp_move("(-3T2)Qa2c5"), {
                actions::leaf(temp_move("(5T3)Ra1>(T2)a1")),
                actions::leaf(temp_move("(5T4)Qa1>>(3T3)b1"))
            }),
            actions::branch(temp_move("(-2T2)Qb2c5"), {
                actions::leaf(temp_move("(5T3)a1>(T2)a1")),
                actions::leaf(temp_move("(5T4)Qa1>>(5T3)b1"))
            }),
        }
    );
    std::cout << a;
